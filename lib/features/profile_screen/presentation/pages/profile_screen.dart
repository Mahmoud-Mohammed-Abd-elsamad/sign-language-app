...
class ProfileScreen extends StatelessWidget {
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Container(
                    child: Icon(
                      CupertinoIcons.profile_circled,size: 120.w,
                    ),
                  )
                ),
              ),
          Center(
            child: Text("Mahmoud Mohammed ",style: GoogleFonts.poppins(fontWeight:FontWeight.w500,color: AppColors.secondaryColor,
                fontSize: 20.sp),),
          ),
              Column(
  ...
  Widget _customItem({required String text,required IconData icon,required void Function() onTap,required bool flipX}){
    return InkWell(
      onTap:onTap ,
      child: Padding(
      ...
      children: [
        ...
        Container(
            ...
            child: Padding(
              ...
              child: Text(text,style:GoogleFonts.poppins(color: AppColors.secondaryColor,fontSize: 16.sp,fontWeight: FontWeight.w500),),
            ))
